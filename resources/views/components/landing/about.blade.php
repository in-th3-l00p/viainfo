        ...
        <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div class="lg:pr-8 lg:pt-4">
                <div class="lg:max-w-lg">
                    <h2 class="text-base font-semibold leading-7 text-blue-600">Despre ViaInfo!</h2>
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-600">
                        La ViaInfo, predăm informatica la un nivel de excelență, evidențiind importanța acesteia în societatea modernă. Cercul nostru dezvoltă abilități esențiale pentru inovație și gândire critică, pregătind participanții pentru provocările digitale viitoare.
                    </p>
                </div>
            </div>
